 ...
 * 
 * Usage: node scripts/createTestFeedback.js [--count=10]
 */
...
function generateResponse(template, message) {
  ...
  const responses = {
    "zero-g": "Zero-gravity training is a critical component of astronaut preparation. It typically involves parabolic flight training, neutral buoyancy lab exercises, and virtual reality simulations. The key is to gradually expose your body to the sensations of weightlessness while learning to perform essential tasks.",
    "physical": "Astronaut physical training focuses on cardiovascular endurance, strength training, and flexibility. NASA recommends at least 2.5 hours of aerobic exercise plus strength training 2-3 times per week. Core strength is particularly important for maintaining posture and preventing injury in microgravity.",
  ...
  if (template.content.length > 0) {
    return template.content + " " + baseResponse;
  }
