...
userSchema.methods = {
  ...
  calculateLeaderboardScore: async function () {
    try {
      ...
      if (!this.leaderboard.history?.length || 
        ...
        this.leaderboard.history.push({
          ...
          breakdown: {
            ...
            streakScore: this.leaderboard?.history?.length > 0 ? 
                        this.leaderboard.history[this.leaderboard.history.length - 1].breakdown.streakScore : 0,
