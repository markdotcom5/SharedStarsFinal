document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('/api/academy')
        ...
        .catch((error) => {
            ...
            modulesContainer.innerHTML =
                '<li class="error">Failed to load academy modules. Please try again later.</li>';
        });
});
// Add to academy.js
class AISpaceGuide {
    ...
    initializeGuidanceOverlay() {
        ...
        overlay.className =
            'ai-guidance-system fixed bottom-4 left-4 w-96 bg-black/80 rounded-xl p-4 text-white z-50';
        overlay.innerHTML = `
