...
class EVAModule {
    ...
    setupEventListeners() {
        ...
        document.addEventListener('eva:emergencyStop', () => 
        ...
        this.progressTracker.on('progress', (progress) => 
            this.interface.updateStatus(progress));
    }
    ...
    handleInitializationError(error) {
        ...
        this.interface.showError('Module initialization failed. Please refresh the page.', 'critical');
    }
