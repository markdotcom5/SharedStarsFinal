        ...
        try {
            ...
            if (!existingModuleProgress) {
                ...
                const newModuleProgress = {
                    ...
                    milestones:
                        module.trainingStructure.progression?.milestones?.map((milestone) => ({
                            name: milestone.name,
                            completed: false,
                            dateAchieved: null,
                        })) || [],
                ...
                console.log(
                    `✅ Module progress initialized for user ${userId} and module ${module.moduleId}`
                );
                return newModuleProgress;
            }

            console.log(
                `ℹ️ Module progress already exists for user ${userId} and module ${module.moduleId}`
            );
